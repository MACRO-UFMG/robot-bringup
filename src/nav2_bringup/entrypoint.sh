...
# ros2 launch nav2_bringup localization_launch.py   namespace:=$NAMESPACE params_file:=/home/ros/ros2_ws/src/config/nav2_skymu.yaml   map:=/home/ros/ros2_ws/src/maps/coro_new.yaml

# ros2 launch nav2_bringup localization_launch.py \
#   namespace:=$NAMESPACE \
#   params_file:=/home/ros/ros2_ws/src/config/nav2_skymu.yaml \
#   map:=/home/ros/ros2_ws/src/maps/coro_new.yaml

ros2 launch nav2_namespace_bringup nav2_with_namespace.launch.py namespace:=$NAMESPACE

# ros2 launch nav2_namespace_bringup nav2_with_namespace.launch.py
